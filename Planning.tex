...
and GotoGoal exits when the robot reaches the goal. The arrows in Figure \ref{fig:Maze} show the 
recursively optimal policy. The arrows in the left room indicates a policy which seeks to exit
the left room with minimum steps. The arrows in the right room seeks a shortest path to the goal.
Note that in the shaded area, 
