...
%An overview here
In this chapter, we introduce the primarily property of hierarchical optimal reinforcement learning
and show how to exploit this property to combine model-free and mode-based methods.
...
\begin{definition}
    ...
    %TODO: add external reward and internal reward to say the difference with MAXQ
    \item $\tilde{R}_i(s'|s, a)$ is the pseudo reward function.The reward function may not be the same as the reward function of original MDP $M$. 
    \end{itemize}
\end{definition}
