...
produced by $P_i$ at the state $S$. The state $S$ can be described as $S=I_{P_1}(S)\cup \dots \cup I_{P_n}(S)$. Thus, the predicates in $\mathbb{P}$
...
In this work, we assume the value function which has the following property:
\begin{equation}
V(S) = \sum_{L_i \in S} V_{L_i},
\label{eq:relV}
\end{equation}
in which $L_i$ is a positive literal at the state $S$. $V_{L_i}$ is the utility which contributes to the whole 
...
True $\{Dist(A, M, 1), Dist(A, M, \sqrt{2}), Dist(A, F, \sqrt{2})\}$.
...
Combined with Equation \ref{eq:deltaV}, we can get:
\begin{equation}
...
\hline
\multicolumn{3}{c}{The average reward for different level of training }\\
\hline
$(0, 1)$ & $(1, 0)$ & $(1, 1)$ & $(2, 1)$ & $(1, 2)$ & Reward $(3, 5)$\\
20000    & 0        & 0        & 0        & 0        & -11.9088\\
10000    & 10000    & 0        & 0        & 0        & \ -5.8666\\
6666     & 6666     & 6667     & 0        & 0        & -4.3233\\
0        &          & 20000    & 0        & 0        & 11.4728\\
0        &          & 0        & 0        & 20000    & -8.8101\\
0        &          & 10000    & 0        & 10000    & -15.4953\\
4000     & 4000     & 4000     & 4000     & 4000     & -13.3894\\
\hline
...
\multicolumn{3}{c}{The average reward for different level of training }\\
\hline
$(0, 1)$ & $(1, 0)$ & $(1, 1)$ & $(2, 1)$ & $(1, 2)$ & Reward $(6, 10)$\\
20000    & 0        & 0        & 0        & 0        & -6.0867\\
10000    & 10000    & 0        & 0        & 0        & 2.2270\\
6666     & 6666     & 6667     & 0        & 0        & -0.9143\\
0        &          & 20000    & 0        & 0        &  6.7395 \\
0        &          & 0        & 0        & 20000    & -2.1970\\
0        &          & 10000    & 0        & 10000    & -18.9684\\
4000     & 4000     & 4000     & 4000     & 4000     & -11.0146\\
\hline
\hline
\end{tabular}
%\caption{The features used by predicates.}
...
the sum of several local functions which are defined over relational predicates or templates.
Our work argues that the learning process can be more efficient if the value associated with
each relational predicate is first learned in a simple setting, then gradually transfer 
it to more and more complex scenarios. 
...
78. Compoare with baseline linear sarsa with transfer learning
79. Use grid world as motivating example
