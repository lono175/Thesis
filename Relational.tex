...
Most recently, Asgharbeygi et al. \cite{RRLTD} proposed relational temporal difference learning 
to learn a distributed value function represented over a conceptual hierarchy of relational predicates. 
Proper et al. \cite{RelationalTemplate} uses relational templates to transfer the knowledge from 
