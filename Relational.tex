...
\begin{definition} Relational Markov decision process (RMDP) is formalized as a tuple $<\mathbb{P}, \mathbb{A}, \mathbb{D}, \mathbb{T}, \mathbb{R}>$, where
\begin{itemize}{}
    \item $\mathbb{P}$ is a set of predicates.
    \item $\mathbb{A}$ is a set of actions.
    \item $\mathbb{D}$ is a domain of objects.
...
\item The reward function $\mathbb{R}:\mathbb{S}\times \mathbb{A} \rightarrow {R}$ defines the reward after executing a certain action at a certain state.
\end{itemize}
\end{definition}
